...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "airline@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "airline API";

        private String description = "airline API documentation";
